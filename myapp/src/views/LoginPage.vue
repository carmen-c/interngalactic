		  ...
		  <div class="col-xs-12 loginContainer">
			<div class="form-inline">
  				<div class="login-group">
					<input type="email" name="loginEmail" class="form-control" v-model="loginEmail" placeholder="Email">
                    <input type="password" name="loginPass" class="form-control" v-model="password" placeholder="Password">
